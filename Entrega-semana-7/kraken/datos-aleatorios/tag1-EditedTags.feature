...
Scenario: Como usuario administrador quiero poder crear un nuevo Tag para después editar su contenido
  ...
  And I wait for 1 seconds
  And I enter title "$name_tagTitle" into field with selector "input[id='tag-name']"
  And I wait for 1 seconds
  ...
  And I wait for 1 seconds
  And I click the new tag in order to edit it "$$name_tagTitle"
  And I wait for 1 seconds
  And I enter title "$name_tagTitleModified" into field with selector "input[id='tag-name']"
  And I wait for 1 seconds
  And I click in the save button
