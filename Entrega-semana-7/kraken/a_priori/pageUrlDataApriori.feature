...
Examples:
  | BASEURL                              | USERNAME       | PASSWORD     | PAGE_URL                                                                                                                                                                                                                                                         | COMMENT                                             |
  | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | mañana                                                                                                                                                                                                                                                           | # URL using ñ should not be allowed                 |
  | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 |  | # 256 URL chars long after host                     |
  | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | ******                                                                                                                                                                                                                                                           | # URL using * should not be allowed                 |
  | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | 😎😎😎-😎😎😎😎                                                                                                                                                                                                                                                    | # URL using emojis should not be allowed            |
  | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | !@#$%^&*()                                                                                                                                                                                                                                                       | # URL with special characters                       |
