...
Feature: crear-nuevo-tag-datos-a-priori
  ...
  Scenario Outline: Como usuario administrador quiero agregar un nuevo tag con datos a priori para validar el ingreso de datos
    ...
    Examples:
      | TAG_NAME                                                                                                                                                                                          | COMMENT                                             |
      | Normal Tag Title                                                                                                                                                                                  | # Normal title                                      |
      | !°@()#$%^&*                                                                                                                                                                                       | # Title with special characters                     |
      | 🤯🧐😏                                                                                                                                                                                            | # Title with emojis                                 |
      | empty                                                                                                                                                                                             | # Empty title                                       |
      | Title that contains HTML tags <h1>Header</h1>                                                                                                                                                     | # Title with HTML tags                              |
      | Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. D | # Exceedingly long title (more than 191 characters) |
      | Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculusneses   | # name with max characters (191 characters)         |
