...
Feature: crear-daft-post-datos-a-priori
  ...
  Scenario Outline: Como usuario administrador quiero agregar un draft post con datos a priori para validar el ingreso de datos
    ...
    Examples: 
      | BASEURL                              | USERNAME       | PASSWORD     | POST_TITLE                                                                                                                                                                                                                                                       | COMMENT                                             |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Title with SQL Injection ' OR '1'='1'; --                                                                                                                                                                                                                        | # Title with potential SQL Injection                |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Normal Title                                                                                                                                                                                                                                                     | # Normal title                                      |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Title with script <script>alert('XSS')</script>                                                                                                                                                                                                                  | # Title with potential XSS                          |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | !@#$%^&*()                                                                                                                                                                                                                                                       | # Title with special characters                     |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Title with emojis 😃🎉                                                                                                                                                                                                                                           | # Title with emojis                                 |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Title with HTML tags <h1>Header</h1>                                                                                                                                                                                                                             | # Title with HTML tags                              |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius. Sed non risus. Suspendisse lectus to a | # Exceedingly long title (more than 255 characters) |
      | http://localhost:3001/ghost/#/signin | admin@mail.com | Qazwsxedc123 | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius. Sed non risus. Suspendisse lectus to   | # Under long title (less than 255 characters) |
